...
function _renderQRSVG(text){
  ...
  try{
    ...
    console.error('[QR]',e);
    wrap.innerHTML='<p style="font-size:12px;color:#888;text-align:center;padding:20px;border:1px solid #eee;border-radius:12px;">Use o codigo copia e cola acima.</p>';
  }
}
